...
export const LoginStyles: Record<string, React.CSSProperties> = {
  ...
  panelTagline: {
    ...
    color: "#c8c8d8", marginBottom: 40, margin: "0 0 40px",
  },
  panelStats: { display: "flex", alignItems: "center", gap: 20 },
  stat: { display: "flex", flexDirection: "column", gap: 4 },
  statNum: { fontSize: 16, fontWeight: 700, color: "#7c6af7" },
  statLabel: { fontSize: 10, color: "#555", letterSpacing: "0.1em", textTransform: "uppercase" },
  statDivider: { width: 1, height: 28, background: "#2a2a3a" },
  ...
  btnArrow: { transition: "transform 0.2s" },
